...
<section class="main-table">
    <h3 class="content-title">Add a New Conductor</h3>

    <form class="auth-form" action='../../../../private/includes/admin/conductors/add-handle.php' method="POST">
        <div class="form-control-auth">
            <label for="name">Name</label>
            <input type="text" id="name" name="name" placeholder="Enter conductor name here.." required />
            <div style="color: red;">
        ...
        <div class="form-control-auth">
            ...
            <select name="group" id="group" required>
                <option value="" selected="selected" disabled>Select a conductor from the list below</option>
        ...
        <div class="form-control-auth">
            <button type="submit" class="auth-btn" name="add-conductor">Add</button>
        </div>
    </form>
